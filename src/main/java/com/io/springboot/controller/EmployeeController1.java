...
public class EmployeeController1 {
	...
	public void addClientToEmployee(@PathVariable("employeeId") String employeeId,@PathVariable("clientId") String clientId) {
	...
	public void removeClientFromEmployee(@PathVariable("employeeId") String employeeId,@PathVariable("clientId") String clientId) {
