...
public class ClientController1 {
	...
	public void addEmployeeToClient(@PathVariable("clientId") String clientId,@PathVariable("employeeId") String employeeId) {
	...
	public void removeEmployeeFromCLient(@PathVariable("clientId") String clientId,@PathVariable("employeeId") String employeeId) {
